...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'Built during my software development internship at Gemline. To test an ERP, you place fake orders that look like real customer orders and check that every department receives them and that they move all the way to “waiting to be shipped.” Entering those orders by hand is slow and repetitive: about 12/orders per hour.\n\n' +
      'The tool puts an LLM into that workflow. You describe the orders you need in plain English, and the OpenAI API turns the request into structured parameters. Those parameters drive a SQL query against real order history, which is mapped into the most common combinations (which carriers, countries and quantities usually go together). New orders are then generated by those weights, so the test data looks like Gemline’s actual customers.\n\n' +
      'It looks like a chat box to talk to a chatbot, but it isn’t a chatbot. It doesn’t answer questions; it does the work, producing 1,000+ realistic orders in minutes.',
    highlights: [
